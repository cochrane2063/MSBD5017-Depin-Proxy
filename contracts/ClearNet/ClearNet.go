...
//
// Solidity: function uintToString(uint256 _value) pure returns(string)
func (_Clearnet *ClearnetCaller) UintToString(opts *bind.CallOpts, _value *big.Int) (string, error) {
	var out []interface{}
	err := _Clearnet.contract.Call(opts, &out, "uintToString", _value)
...
//
// Solidity: function uintToString(uint256 _value) pure returns(string)
func (_Clearnet *ClearnetSession) UintToString(_value *big.Int) (string, error) {
	return _Clearnet.Contract.UintToString(&_Clearnet.CallOpts, _value)
}

// UintToString is a free data retrieval call binding the contract method 0xe9395679.
//
// Solidity: function uintToString(uint256 _value) pure returns(string)
func (_Clearnet *ClearnetCallerSession) UintToString(_value *big.Int) (string, error) {
	return _Clearnet.Contract.UintToString(&_Clearnet.CallOpts, _value)
}
